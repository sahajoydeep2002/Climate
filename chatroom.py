...
async def main():
    ...
    put_markdown("## Weather & Climate discuss CHAT Room\nWelcome to the chat room, you can chat with all the people currently online and ask or discuss about the weather or climate worldwide", lstrip=True)
